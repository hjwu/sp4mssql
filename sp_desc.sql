...
BEGIN TRY
    ...
    BEGIN
        ...
        DECLARE @returnTable TABLE([Key] CHAR(1), Name VARCHAR(40), [Type] VARCHAR(50), [Cname] NVARCHAR(40), [Options] VARCHAR(MAX))
        ...
        DECLARE @item NVARCHAR(200), @option VARCHAR(MAX), @comments VARCHAR(MAX)
